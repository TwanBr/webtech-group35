...
<div class="container wallwidth">
        <div class="middle_box">
            ...
            <div class="feed_form">
                <form action="<?php echo base_url('index.php/welcome/submitWallPost');?>" id="frmpost" method="post" enctype="multipart/form-data">
                    <div class="row_ele">
                    ...
                    <div class="row_ele">
                        <button class="btn" id="btnpost"name="submit">Post</button>
                       <!--- <input class="btn" id="btnpost" type="button" name="submit" value="Post"/>
                    --></div>
                </form>
                <div id="message"></div>
                <!----<form action="<?php //echo base_url('index.php/welcome/uploadfile');?>" id="myform" enctype="multipart/form-data" method="post">
